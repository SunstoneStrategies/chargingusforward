...
const appData = {
  pointsData: [
    {
      name: "Los Angeles, CA at Santa Monica Pier",
      state: "California",
      ...
      vimeoVideo: "https://vimeo.com/451966658",
      youtubeVideo: "https://www.youtube.com/watch?v=5qap5aO4i9A",
      image:
        "https://images.unsplash.com/photo-1593642532452-9d5c0b2b0b2a?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
    },
    {
      name: "Cleveland OH",
      state: "Ohio",
    ...
    },
    {
      ...
      state: "Illinois",
      title: "Joliet, IL",
      coordinates: [-89.242198, 39.744364],
      description:
